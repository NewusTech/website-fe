      ...
      <section className="my-2">
        ...
        <div className="mt-6 md:mt-10 md:text-[28px] text-[8px]">
          <p className="text-justify">
            ...
            part of Cicero's De Finibus in order to provide placeholder text to
            mockup various fonts for a type specimen book. It's difficult to
            ...
            book.It's difficult to find examples of lorem ipsum in use before
            ...
            in use far before the age of Letraset It's difficult to find
            ...
            far before the age of Letraset It's difficult to find examples of
