  ...
  return (
    <html lang="en">
      <head>
        ...
        <Script id="GTM">
          {`(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start': new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0], j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src='https://www.googletagmanager.com/gtag/js?id='+i+dl;f.parentNode.insertBefore(j,f);})(window,document,'script','dataLayer','${seoGtm.googleTagManager}');`}
        </Script>
      </head>
      <body className={inter.className}>
        ...
        <noscript>
          <iframe
            src={`https://www.googletagmanager.com/ns.html?id=${seoGtm.googleTagManager}`}
            height="0"
            width="0"
            style={{ display: "none", visibility: "hidden" }}
          ></iframe>
