  ...
  return (
    <header className="w-full z-10 relative">
      <div className="md:min-w-[1350px] md:min-h-[75px]">
        <Image
          src="/assets/images/header-blog.jpg"
          alt="blog header"
          width={1350}
          height={75}
          className="w-full h-full object-cover md:rounded-b-[30px]"
        />
      </div>
      <div className="absolute z-30 w-full -mt-[50px] md:-mt-[160px]">
        <div className="flex flex-col justify-center items-center gap-[10px] md:gap-10">
          ...
          <Input
            ...
            className="bg-white shadow-xl py-5 md:py-6 px-5 w-[300px] md:w-[500px]"
          />
        </div>
      </div>
    </header>
