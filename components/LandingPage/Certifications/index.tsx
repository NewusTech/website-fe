...
export default async function Certifications() {
  ...
  return (
    <div className="text-center md:px-8 2xl:container mx-auto bg-gray-100 md:pb-10 xl:-mt-20">
      <div className="md:mt-10 mt-[10px] flex justify-between items-center   gap-3 md:gap-5 px-5 md:px-0 md:pb-5">
