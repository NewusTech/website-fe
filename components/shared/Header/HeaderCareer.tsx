...
const Header = ({
  ...
  return (
    <header className="w-full z-10 relative">
      <div className="h-[471px] bg-[url('/assets/images/career-header.svg')] flex justify-center items-center">
        <div className="flex flex-col justify-center items-center md:gap-[21px] max-w-[831px]">
          <h1 className="text-white uppercase font-bold text-[10px] md:text-[24px]">
            Were hiring !
          </h1>
          <h2 className="text-[#FF6600] font-bold md:text-[56px]">Be part of our mission.</h2>
