  ...
  return (
    <section className="max-w-screen 2xl:container 2xlmx-auto">
      <div className="2xl:w-[72%] container mx-auto flex justify-between md:mt-[30px] items-center md:z-20 md:top-0 md:absolute py-[22px] md:py-0" >
        ...
        {openDropdown && (
          <nav className="absolute top-14 md:top-16 right-0 z-50 bg-white md:bg-white/20 md:backdrop-blur-lg w-72 md:w-[300px] mt-5 md:mt-0 py-5 px-6 shadow-lg md:rounded-md md:right-6">
