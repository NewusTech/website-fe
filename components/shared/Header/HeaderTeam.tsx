  ...
  return (
    <header className="w-full z-10 relative">
      ...
      <div className="relative flex justify-center items-center h-full">
        <div className="absolute top-[-155px] md:top-[-356px] lg:top-[-380px] xl:top-[-500px] 2xl:top-[-500px] right-2 sm:right-4 lg:right-5 2xl:right-20 opacity-[1] w-[140px] md:w-[300px] xl:w-[400px] md:max-w-[300px] xl:max-w-[415px] text-white text-left md:text-left">
