...
const Medias = ({ medias }: any) => {
  ...
  return (
    <div>
      <div className={`px-4 md:px-[50px] pb-10 min-h-[250px] md:min-h-[500px] 2xl:min-h-[892px]] bg-contain bg-center flex justify-center items-end`} style={{ backgroundImage: `url('${backgroundUrl}')` }}>
      ...
      <div className={`flex w-full h-[160px] md:h-[300px] overflow-auto ${medias.length > 4 ? 'overflow-auto' : ''} md:h-full`} style={{ overflowX: 'scroll', scrollbarWidth: 'thin', msOverflowStyle: 'scrollbar', overflowY: 'hidden' }}>
