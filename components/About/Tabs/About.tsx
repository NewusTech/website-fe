  ...
  return (
    <section className='-mt-[8px] md:px-[67px] px-5 pt-2 md:pt-14 pb-4 md:py-[64px] md:border bg-white md:border-[#FF6600]'>
      <div className='pt-5 pb-3 md:pb-10'>
        ...
        <p className='text-mobileSubjudul md:text-webSubjudul leading-6 md:leading-8 text-justify md:text-start'>{removeHTMLTags(abouts[0]?.body) || 'Newus technology adalah sebuah perusahaan software yang bergerak dibidang jasa pembuatan website, aplikasi / sistem dan aplikasi berbasis android serta IOS. Selain sebagai perusahaan software newus technology merupakan sebuah perusahaan konsultan IT yang berdomisili di Kota Bandar Lampung.'}</p>
      </div>
