        ...
        >
          ...
          >
            ...
            <div className="relative">
              <div className="absolute top-[-135px] md:top-[-235px] left-[250px] xl:top-[-246px] 2xl:top-[-406px] md:left-[460px] xl:left-[450px] 2xl:left-[680px] opacity-[1] max-w-[130px] md:max-w-[300px] xl:max-w-[400px] text-white">
                ...
                <p className="md:hidden text-mobileDesk 2xl:text-[14px] capitalize leading-3 font-light">
                  {removeHTMLTags(teams?.description) || 'Lorem ipsum dolor sit amet consectetur. Volutpat velit nibh orci eu vel a phasellus dui est. Habitasse eget cum sed pulvinar morbi. Lorem ipsum dolor sit amet consectetur.'}
