      ...
      >
        ...
        <div className='md:flex w-full gap-4'>
          ...
          <div className='flex flex-col gap-2 md:w-1/2'>
            ...
            <select name="service" id="service" className='text-[12px] md:text-sm border bg-[#F4F4F4] border-[#DDE5E9] rounded-lg px-4 py-[11px]'>
        ...
        <div className='flex flex-col w-full gap-2'>
          ...
          <textarea name="projectDesc" placeholder='Input here' className='border bg-[#F4F4F4] text-[12px] md:text-sm border-[#DDE5E9] rounded-lg px-4 py-[11px]'></textarea>
        </div>

        <div className='flex flex-col gap-2'>
          <label htmlFor="projectDeadline" className='text-[12px] md:text-sm font-[500]'>Project Deadline</label>
          <select name="projectDeadline" id="projectDeadline" className='border text-[12px] md:text-sm bg-[#F4F4F4] border-[#DDE5E9] rounded-lg px-4 py-[11px]'>
