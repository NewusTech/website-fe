...
const LifeCycle = () => {
  return (
    <div className="relative pt-40 pb-10">
      <div className="relative z-10 flex justify-center gap-20 px-5">
        ...
        <div className="flex flex-col items-center gap-3 -mt-32">
          <div className="flex flex-col justify-center items-center">
            <h2 className="text-webJudul font-semibold mt-4 text-blue py-2 shadow shadow-tangerine rounded-sm px-3">Feasibility Study</h2>
        ...
        <div className="flex flex-col items-center gap-3">
          <div className="flex flex-col justify-center items-center -mt-32">
            <h2 className="text-webJudul font-semibold mt-4 text-blue py-2 shadow shadow-tangerine rounded-sm px-3">Testing the Product</h2>
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <div className="flex flex-col justify-center items-center">
            ...
            <h2 className="text-webJudul text-blue font-semibold mt-4 py-2 shadow shadow-tangerine rounded-sm px-3">Deployment & Maintenance</h2>
          </div>
        </div>
      </div>
    </div>
