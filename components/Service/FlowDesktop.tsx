  ...
  return (
    <section className="md:flex flex-col items-center md:mb-10 hidden  overflow-hidden">
      ...
      <div className="mt-[75px] mr-40 flex justify-around overflow-hidden">
        <div className="flex flex-col items-center gap-y-3">
          <div className="rounded-full w-[155px] h-[155px] bg-blue flex items-center justify-center">
            <p className="text-white font-bold md:text-webJudul text-mobileJudul">1</p>
          </div>
          <h3 className="text-tangerine md:text-webJudul text-mobileJudul font-bold">
            Kick-off Meeting
          </h3>
          <p className="md:text-webSubJudul text-mobileSubjudul w-[353px] text-center leading-loose">
      ...
      <div className="flex overflow-hidden">
        <div className="flex flex-col items-center gap-y-3">
          <div className="rounded-full w-[155px] h-[155px] bg-blue flex items-center justify-center">
            <p className="text-white font-bold md:text-webJudul text-mobileJudul">3</p>
          </div>
          <h3 className="text-tangerine md:text-webJudul text-mobileJudul font-bold">Solution</h3>
          <p className="md:text-webSubJudul text-mobileSubjudul w-[353px] text-center leading-loose">
        ...
        <Image
          ...
          height={0}
          alt="line"
          className="-z-10 -mt-28 -mx-36 xl:-mx-24 overflow-hidden"
        />
        <div className="flex flex-col items-center gap-y-3 overflow-hidden">
          <div className="rounded-full w-[155px] h-[155px] bg-blue flex items-center justify-center">
      ...
      <div className="flex mt-2 overflow-hidden">
        <div className="flex flex-col items-center ml-[0px] xl:ml-[90px]">
          ...
          <div className="flex flex-col items-center gap-y-3">
            <div className="rounded-full w-[155px] h-[155px] bg-blue flex items-center justify-center">
              <p className="text-white font-bold md:text-webJudul text-mobileJudul">4</p>
            </div>
            <h3 className="text-tangerine md:text-webJudul text-mobileJudul font-bold">
              Development
            </h3>
      ...
      <div className="flex items-start mt-2 overflow-hidden">
        <div className="flex flex-col items-center gap-y-3 ml-10 -mr-28">
          <div className="rounded-full w-[155px] h-[155px] bg-blue flex items-center justify-center">
            <p className="text-white font-bold md:text-webJudul text-mobileJudul">6</p>
          </div>
          <h3 className="text-tangerine md:text-webJudul text-mobileJudul w-[380px] font-bold text-center">
        ...
        <div className="flex flex-col items-center gap-y-3 mr-40 -ml-20">
          <div className="rounded-full w-[155px] h-[155px] bg-blue flex items-center justify-center">
            <p className="text-white font-bold md:text-webJudul text-mobileJudul">5</p>
          </div>
          <h3 className="text-tangerine md:text-webJudul text-mobileJudul font-bold">
